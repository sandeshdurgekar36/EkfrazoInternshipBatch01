# Generated by Django 4.0.3 on 2022-05-18 12:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.FileField(null=True, upload_to='images/Profile_image')),
                ('pancard_image', models.FileField(null=True, upload_to='images/Pancard_image')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_image', models.FileField(null=True, upload_to='images/License_image')),
                ('fitness_certificate_image', models.FileField(null=True, upload_to='images/Fitness_certificate_image')),
                ('permit_expire_date', models.DateField(null=True)),
                ('emission_test_image', models.FileField(null=True, upload_to='images/Emission_image')),
                ('insurence_image', models.FileField(null=True, upload_to='images/Insurence_image')),
                ('rc_image', models.FileField(null=True, upload_to='images/Rc_image')),
                ('permit_expire_image', models.FileField(null=True, upload_to='images/Permit_image')),
                ('account_id', models.IntegerField(null=True)),
                ('subscription_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.subscription')),
            ],
        ),
        migrations.CreateModel(
            name='Drop_details',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver_user_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.driver')),
            ],
        ),
        migrations.CreateModel(
            name='Pickup_details',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicles_type_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.vehicletype')),
            ],
        ),
        migrations.CreateModel(
            name='Place_order',
            fields=[
                ...
                ('vehicles_type_id', models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.CASCADE, to='api.vehicletype')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='driver',
            name='vehicle_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.vehicletype'),
        ),
    ]
